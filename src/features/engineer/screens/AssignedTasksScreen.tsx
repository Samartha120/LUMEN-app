...
const TASKS: Task[] = [
  { id: "T001", title: "Repair large pothole on MG Road", address: "123 MG Road", category: "road", priority: "high", status: "in_progress", assignedAt: "Today, 9 AM", distance: "1.2 km", sla: "6 hours" },
  { id: "T002", title: "Fix street light panel", address: "Park Ave, 2nd Block", category: "streetlight", priority: "medium", status: "pending", assignedAt: "Today, 8 AM", distance: "3.4 km", sla: "24 hours" },
  { id: "T003", title: "Water valve replacement", address: "5th Cross, Gandhi Nagar", category: "water", priority: "high", status: "pending", assignedAt: "Today, 7:30 AM", distance: "5.1 km", sla: "12 hours" },
  { id: "T004", title: "Garbage collection assist", address: "Gandhi Nagar Main St", category: "garbage", priority: "low", status: "pending", assignedAt: "Yesterday", distance: "6.8 km", sla: "48 hours" },
  { id: "T005", title: "Electrical sparks inspection", address: "Residency Road", category: "electricity", priority: "high", status: "done", assignedAt: "Yesterday", distance: "2.3 km", sla: "Completed" },
];
...
export default function AssignedTasksScreen() {
  ...
  const filtered = TASKS.filter(t => {
    const matchFilter = filter === "all" || (filter === "urgent" && t.priority === "high") || filter === "today" || filter === "week";
          ...
          return (
            ...
            >
              <View style={s.cardTop}>
                <View style={[s.catIcon, { backgroundColor: PRIORITY_COLOR[task.priority] + "15" }]}>
                  <LumenIcon name={task.category} size="md" color={PRIORITY_COLOR[task.priority]} strokeWidth={2} />
                </View>
                <View style={s.cardInfo}>
                  <Text style={[TextStyles.bodyMedium, { color: colors.textPrimary }]} numberOfLines={2}>{task.title}</Text>
              ...
              <View style={[s.cardFooter, { borderTopColor: colors.borderDefault }]}>
                ...
                <View style={s.footerItem}>
                  ...
                  <Text style={[TextStyles.caption, { color: colors.textSecondary }]}>SLA: {task.sla}</Text>
                </View>
                <View style={s.footerItem}>
                  <LumenIcon name="calendar" size="xs" color={colors.textTertiary} strokeWidth={2} />
                  <Text style={[TextStyles.caption, { color: colors.textSecondary }]}>{task.assignedAt}</Text>
                </View>
              </View>
            </Card>
          );
