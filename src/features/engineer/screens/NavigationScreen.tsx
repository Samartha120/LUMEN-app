...
const DIRECTIONS = [
  ...
  {
    icon: "chevronRight",
    instruction: "Turn right at City Bank signal",
    distance: "0.5 km",
    time: "4 min",
  },
  ...
  {
    icon: "chevronLeft",
    instruction: "Turn left at Park Avenue",
    distance: "0.1 km",
    time: "1 min",
  },
  ...
  return (
    <View style={[s.root, { backgroundColor: colors.bgBase }]}>
      ...
      <View style={[s.header, { borderBottomColor: colors.borderDefault }]}>
        ...
        <Badge
          label={navigating ? "Live" : "Preview"}
          variant={navigating ? "success" : "neutral"}
          dot={navigating}
        />
      </View>
              ...
              <View style={s.dirLeft}>
                <View
                  style={[
                    ...
                    {
                      backgroundColor:
                        i === DIRECTIONS.length - 1 ? colors.brand + "15" : colors.bgSubtle,
                    },
                  ]}
                >
                  <LumenIcon
                    name={d.icon as any}
                    size="sm"
                    color={i === DIRECTIONS.length - 1 ? colors.brand : colors.textSecondary}
                    strokeWidth={2}
                  />
                </View>
                {i < DIRECTIONS.length - 1 && (
                  <View style={[s.dirLine, { backgroundColor: colors.borderDefault }]} />
                )}
              </View>
