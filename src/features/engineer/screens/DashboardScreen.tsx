        ...
        <Animated.View style={[s.header, { opacity: headerFade }]}>
          <View style={s.headerContent}>
            <View style={s.greetingWrap}>
              <Text style={[TextStyles.label, { color: "#7C3AED", letterSpacing: 1 }]}>
                {GREET()}
              </Text>
              <Text
                    ...
                    return (
                      ...
                      >
                        ...
                        <Text
                          style={[
                            TextStyles.label,
                            { color: active ? c.color : colors.textTertiary },
                          ]}
                        >
                          {c.label}
                        </Text>
            ...
            <Animated.View style={[s.section, { opacity: taskAnim }]}>
              ...
              <Pressable onPress={() => router.push("/(engineer)/Task-details" as any)}>
                <BlurView intensity={20} tint={isDark ? "dark" : "light"} style={s.glassCard}>
                  <LinearGradient
                    colors={[
                      isDark ? "#1a1a2e20" : "#ffffff40",
                      isDark ? "#1a1a2e10" : "#ffffff20",
                    ]}
                    start={{ x: 0, y: 0 }}
                    end={{ x: 1, y: 1 }}
                    style={StyleSheet.absoluteFill}
                  ...
                  <View style={s.priorityCard}>
                    <View style={s.priorityHeader}>
                      <View
                        style={[
                          s.priorityIcon,
                          { backgroundColor: PRIORITY_COLOR[TASKS[0].priority] + "20" },
                        ]}
                      >
                        <LumenIcon
          ...
          <Animated.View style={[s.section, { opacity: listAnim }]}>
            ...
            {TASKS.slice(1).map((task, idx) => (
              ...
              >
                ...
                >
                  <View
                    style={[s.taskGlow, { backgroundColor: PRIORITY_COLOR[task.priority] + "08" }]}
                  />
