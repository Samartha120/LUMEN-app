...
export const ROUTING_RULES: CategoryMapping[] = [
  { issueType: "Road Damage", department: "roads_and_transport", defaultPriority: "high", slaHours: 48 },
  { issueType: "Streetlight", department: "electricity_board", defaultPriority: "medium", slaHours: 24 },
  ...
  { issueType: "Tree Fall", department: "parks_and_recreation", defaultPriority: "medium", slaHours: 24 },
  { issueType: "Public Property", department: "municipal_maintenance", defaultPriority: "low", slaHours: 72 },
  { issueType: "Illegal Construction", department: "urban_planning", defaultPriority: "medium", slaHours: 168 }, // 1 week
  { issueType: "Animal Issue", department: "animal_welfare", defaultPriority: "medium", slaHours: 12 },
  { issueType: "Electric Hazard", department: "electricity_board", defaultPriority: "critical", slaHours: 2 },
  { issueType: "Traffic Signal", department: "traffic_department", defaultPriority: "critical", slaHours: 4 },
  { issueType: "Bridge Damage", department: "civil_engineering", defaultPriority: "critical", slaHours: 12 },
];
...
export class RoutingEngine {
  ...
  static async mockAiCategorySuggestion(imageDescription: string): Promise<CategoryMapping> {
    ...
    } else if (lowerDesc.includes("light") || lowerDesc.includes("pole") || lowerDesc.includes("dark")) {
      bestMatch = ROUTING_RULES.find(r => r.issueType === "Streetlight")!;
    } else if (lowerDesc.includes("wire") || lowerDesc.includes("electric") || lowerDesc.includes("spark")) {
