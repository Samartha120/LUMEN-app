...
export class AiController {
  ...
  @Post('predict/image')
  @ApiOperation({ summary: 'Synchronously predict damage class and bounding boxes for an image URL' })
  predictImage(@Body() body: PredictMediaDto) {
    return this.aiService.processImagePrediction(body.complaintId, body.mediaUrl);
  }
  ...
  @ApiOperation({ summary: 'Fetch AI prediction results for a specific complaint' })
