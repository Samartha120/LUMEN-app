            ...
            <View key={t.step} style={s.timelineRow}>
              <View style={s.timelineLeft}>
                ...
                {i < TIMELINE.length - 1 && (
                  <View
                    style={[
                      s.tlLine,
                      { backgroundColor: i < 4 ? colors.brand : colors.borderDefault },
                    ]}
                  />
                )}
              </View>
              <View style={s.timelineContent}>
                <Text
                  style={[
                    TextStyles.label,
                    { color: t.done ? colors.textPrimary : colors.textTertiary },
                  ]}
                >
                  {t.step}
                </Text>
          ...
          <View style={s.engineerCard}>
            ...
            <View style={s.engineerInfo}>
              ...
              <Text style={[TextStyles.caption, { color: colors.textSecondary }]}>
                Senior Field Engineer · Zone B
              </Text>
              <Badge label="On Site" variant="success" size="sm" dot />
            </View>
            <Pressable
              style={[s.callBtn, { backgroundColor: colors.successBg }]}
        ...
        <Card variant="elevated" style={s.section}>
          ...
          {[
            ...
            <View key={label} style={[s.detailRow, { borderBottomColor: colors.borderDefault }]}>
              <Text style={[TextStyles.label, { color: colors.textTertiary, width: 100 }]}>
                {label}
              </Text>
          ...
          {ACTIVITY.map((a, i) => (
            <View key={i} style={s.activityRow}>
              ...
              <View style={s.activityInfo}>
                <Text style={[TextStyles.bodySmall, { color: colors.textPrimary }]}>
                  {a.action}
                </Text>
